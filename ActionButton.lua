...
addon.ActionButtonPrototype = {};
local Button = addon.ActionButtonPrototype;
...
function Button:IsEquippedAction()
	return IsEquippedAction(self.action)
end
...
function Button:IsActionBeingUsed()
	return IsCurrentAction(self.action) or IsAutoRepeatAction(self.action);
end
...
function Button:IsUsable()
	return IsUsableAction(self.action);
end
...
function Button:GetActionUseCount()
	return GetActionCount(self.action);
end

function Button:ActionHasUseCount()
	return IsConsumableAction(self.action) or IsStackableAction(self.action)
end
...
function Button:GetActionInfo()
	return GetActionInfo(self.action);
end
...
function Button:IsFlashableAction()
	return (IsAttackAction(self.action) and IsCurrentAction(self.action)) or IsAutoRepeatAction(self.action);
end
